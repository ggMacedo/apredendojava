...
public class LivroDAO extends Livro {
    ...
    public void alterar() throws SQLException {
        ...
        try {
            ...
            msgIcon = JOptionPane.ERROR_MESSAGE;
            msg     = "Problema de conex̣o com o BANCO DE DADOS!\n\nFa̤a contato com o HELP DESK!" +
                      "\n\nERRO: " + sqlExc.getMessage();
            JOptionPane.showMessageDialog(null, msg, "Alterando livros...", msgIcon);
            throw new SQLException();
        }
    ...
    // procurar
    public ArrayList<Livro> procurar() throws SQLException {
        int    msgIcon;
        String msg;
        ArrayList<Livro> lista = new ArrayList<Livro>();
        try {
            ...
            String            sqlString = "SELECT * FROM tbLivro WHERE titulo = ?";
            DBConnection      db        = new DBConnection();
            Connection        conn      = db.conectar();
            PreparedStatement ps        = conn.prepareStatement(sqlString);
            ...
            conn.close();
            JOptionPane.showMessageDialog(null, msg, "Procurando livros...", msgIcon);
