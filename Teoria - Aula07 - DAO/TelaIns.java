...
public class TelaIns extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent evt) {
        if      (evt.getSource() == btnFim) { this.dispose(); }
            ...
            if (!txtTitulo.getText().isBlank() && !txtEdicao.getText().isBlank()) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Coloque apenas números no campo EDIÇÃO!!!", "Ooops", JOptionPane.ERROR_MESSAGE);
